...
2.24 Click on “Continue” button
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        laptopsAndNotebooksPage.enterName("Shubham");
        laptopsAndNotebooksPage.enterLastName("lohar");
        laptopsAndNotebooksPage.enterEmail("prime123" + getAlphaNumericString(3) + "@gmail.com");
        laptopsAndNotebooksPage.enterTelephone("9828127783");
        laptopsAndNotebooksPage.enterAddress("82,ThronbridgeAvenue");
        laptopsAndNotebooksPage.enterCity("Birmingham");
        laptopsAndNotebooksPage.enterPostcode("B422PR");
        laptopsAndNotebooksPage.enterCountry("UnitedKindom");
        laptopsAndNotebooksPage.enterZone("Sakani");
